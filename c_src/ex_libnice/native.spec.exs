...
spec remove_stream(state, stream_id :: unsigned) :: :ok
...
spec forget_relays(state, stream_id :: unsigned, component_id :: unsigned) :: :ok
...
spec set_remote_credentials(state, credentials :: string, stream_id :: unsigned) :: :ok
       | {:error :: label, :failed_to_set_credentials :: label}

spec gather_candidates(state, stream_id :: unsigned) :: :ok
       | {:error :: label, :invalid_stream_or_allocation :: label}

spec peer_candidate_gathering_done(state, stream_id :: unsigned) :: :ok
...
spec restart(state) :: :ok
       | {:error :: label, :failed_to_restart :: label}

spec restart_stream(state, stream_id :: unsigned) :: :ok
       | {:error :: label, :failed_to_restart :: label}

spec send_payload(state, stream_id :: unsigned, component_id :: unsigned, data :: payload) :: :ok
